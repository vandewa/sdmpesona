<div>
    {{-- <x-slot name="header">
        <div class="mb-2 row">
            <div class="col-sm-6">
                <h1 class="m-0">Perubahan Gaji</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active">Master</li>
                    <li class="breadcrumb-item"><a href="#">Perubahan Gaji</a></li>
                </ol>
            </div>
        </div>
    </x-slot> --}}
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="mb-2 row">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <input type="number"
                                                                                        class="form-control"
                                                                                        wire:model='form.gapok_baru'>
                                                                                    @error('form.gapok_baru')
                                                                                        <span
                                                                                            class="form-text text-danger">{{ $message }}</span>
                                                                                    @enderror
                                                                                </div>
                                                                            ...
                                                                            <div class="mb-2 row">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <input type="date"
                                                                                        class="form-control"
                                                                                        wire:model='form.tgl_gaji_baru'>
                                                                                    @error('form.tgl_gaji_baru')
                                                                                        <span
                                                                                            class="form-text text-danger">{{ $message }}</span>
                                                                                    @enderror
                                                                                </div>
                                                                        ...
                                                                        <tbody>
                                                                            @foreach ($post as $item)
                                                                                <tr wire:key='{{ $item->id }}'>
                                                                                    ...
                                                                                    <td> {{ $item->tgl_gaji_baru ?? '-' }}
                                                                                    </td>
                                                                                    <td> {{ $item->pegawai->name ?? '-' }}
                                                                                    </td>
                                                                                    <td>{{ \Laraindo\RupiahFormat::currency($item->gapok_baru ?? 0) }}
                                                                                    </td>
                                                                                    <td>
                                                                                        <div
